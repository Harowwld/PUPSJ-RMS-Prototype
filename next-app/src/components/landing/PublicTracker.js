  ...
  return (
    <section id="tracker" className="max-w-7xl mx-auto px-4 sm:px-6 pb-20 w-full font-inter select-none">
      <motion.div 
        ...
        className="rounded-[2.5rem] bg-white  border border-black/[0.06] [0.08] shadow-[0_20px_50px_-15px_rgba(0,0,0,0.06)] overflow-hidden p-8 sm:p-12 relative"
      >
        ...
        {error && (
          <motion.div 
            ...
            className="mt-5 p-4 rounded-2xl bg-red-50/80  border border-red-200  text-xs text-red-800 "
          >
            {error}
          </motion.div>
        )}
              ...
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-6 border-b border-gray-200/80 ">
                <div>
                  ...
                  <p className="text-xs text-gray-500  mt-1.5 font-normal">
                    Requester: <span className="font-semibold text-gray-800 ">{result.masked_name}</span> ({result.masked_student_no}) · Client: {result.client_type}
                  </p>
                </div>

                <div className="text-xs font-mono text-gray-400  sm:text-right">
                    ...
                    return (
                      ...
                      >
                        <div className="flex items-center gap-2 mb-1.5">
                          ...
                          <span className={`text-xs font-bold ${isDone ? "text-gray-950 " : "text-gray-400"}`}>
                            {step.label}
                          </span>
                        </div>
