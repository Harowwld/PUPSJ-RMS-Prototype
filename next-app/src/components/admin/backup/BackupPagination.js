    ...
    <div className="flex shrink-0 items-center justify-between border-t border-gray-100 bg-gray-50 px-6 py-4">
      <div className="flex items-center gap-4 text-xs font-medium text-gray-500">
        <span>
          ...
          <strong className="text-gray-900">{totalCount.toLocaleString()}</strong>{" "}
          entries
        </span>
      ...
      <div className="flex items-center gap-2">
        <Button
          ...
          className="h-8 rounded-brand border-gray-300 px-3 text-[10px] font-black tracking-widest text-gray-600 uppercase hover:border-pup-maroon hover:bg-red-50/30 hover:text-pup-maroon shadow-sm transition-colors active:scale-95 disabled:opacity-30"
        >
