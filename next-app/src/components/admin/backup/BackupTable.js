...
export default function BackupTable({
  ...
  return (
    <div
      className={`flex-1 overflow-auto rounded-brand transition-all duration-300 ${
                ...
                <Empty className="flex h-[400px] flex-col items-center justify-center border-0 text-center text-gray-500">
                  <EmptyHeader className="flex flex-col items-center gap-0">
                    <EmptyMedia className="mb-4 flex h-16 w-16 items-center justify-center rounded-full border border-gray-200 bg-white shadow-sm">
                      <i className="ph-duotone ph-database text-3xl text-pup-maroon"></i>
                    </EmptyMedia>
                    ...
                    <EmptyDescription className="mt-1 max-w-md text-sm font-medium text-gray-600">
                      There are no local database backups in the history log
                      yet.
                    </EmptyDescription>
                    <Button
                      variant="outline"
                      ...
                      <Tooltip>
                        <TooltipTrigger asChild>
                          <button
                            ...
                            className="flex items-center gap-1.5 rounded-md border border-pup-maroon/20 bg-white px-2 py-1 text-pup-maroon shadow-sm transition-all hover:bg-red-50 active:scale-95 disabled:opacity-50"
                          >
                            <i
                              className={`ph-bold ${
