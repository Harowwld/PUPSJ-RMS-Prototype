      ...
      <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
        ...
        <div className="flex flex-col gap-4">
          <div className="flex items-center gap-2.5">
            ...
            <h5 className="text-[10px] font-black tracking-widest text-gray-400 dark:text-zinc-300">
              Rich Description
            </h5>
          </div>
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="space-y-4 rounded-2xl border border-gray-200 bg-white p-5 shadow-sm ring-1 ring-black/5 dark:border-white/10 dark:bg-card dark:shadow-none">
            <div className="flex items-center justify-between">
              <span className="text-[10px] font-black text-gray-400 dark:text-zinc-300">IP ADDRESS:</span>
            ...
            <div className="flex flex-col gap-2 border-t border-gray-50 pt-4 dark:border-white/10">
              <span className="text-[10px] font-black text-gray-400 dark:text-zinc-300">USER AGENT:</span>
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="space-y-4 rounded-2xl border border-gray-200 bg-white p-5 shadow-sm ring-1 ring-black/5 dark:border-white/10 dark:bg-card dark:shadow-none">
            <div className="flex items-center justify-between">
              <span className="text-[10px] font-black text-gray-400 dark:text-zinc-300">TARGET TYPE:</span>
              <span className="rounded-xl bg-emerald-50 border border-emerald-100/30 px-3 py-1 text-[10px] font-black text-emerald-700 shadow-xs dark:bg-emerald-900/30 dark:text-emerald-400 dark:border-emerald-500/10">
                {log.entityType || "N/A"}
              </span>
            </div>
            <div className="flex items-center justify-between border-t border-gray-50 pt-4 dark:border-white/10">
              <span className="text-[10px] font-black text-gray-400 dark:text-zinc-300">REFERENCE ID:</span>
              <div className="flex items-center gap-3">
