                  ...
                  <>
                    <div className="grid grid-cols-2 gap-2 text-white">
                      <div className="bg-white/10 backdrop-blur-sm p-2.5 rounded-lg text-white">
                        ...
                        <span className="text-lg font-black">{(logStats?.totalLogs || 0).toLocaleString()}</span>
                      </div>
                      <div className="bg-white/10 backdrop-blur-sm p-2.5 rounded-lg text-white">
                        <span className="block text-[9px] font-bold text-white/70 uppercase tracking-wider">Active Actors</span>
                        <span className="text-lg font-black">{(logStats?.activeActorsCount || 3).toLocaleString()}</span>
                      </div>
                    </div>
                  ...
                  <>
                    <div className="grid grid-cols-2 gap-2 text-white">
                      <div className="bg-white/10 backdrop-blur-sm p-2.5 rounded-lg text-white">
                        ...
                        <span className="text-lg font-black">{(logStats?.logsToday || 0).toLocaleString()}</span>
                      </div>
                      <div className="bg-white/10 backdrop-blur-sm p-2.5 rounded-lg text-white">
                        <span className="block text-[9px] font-bold text-white/70 uppercase tracking-wider">Hourly Peak</span>
                        <span className="text-lg font-black">{Math.round((logStats?.logsToday || 0) / 8).toLocaleString()}</span>
                      </div>
                    </div>
                  ...
                  <>
                    <div className="grid grid-cols-2 gap-2 text-white">
                      <div className="bg-white/10 backdrop-blur-sm p-2.5 rounded-lg text-white">
                        ...
                        <span className="text-lg font-black">{(logStats?.authEvents || 0).toLocaleString()}</span>
                      </div>
                      <div className="bg-white/10 backdrop-blur-sm p-2.5 rounded-lg text-white">
