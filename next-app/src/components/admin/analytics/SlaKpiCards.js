...
export default function SlaKpiCards({ total, completionRate }) {
  ...
  return (
    <div className="grid grid-cols-1 gap-6 md:grid-cols-2 items-stretch relative z-20 w-full">
      {/* Completion Rate */}
      <div className={cn(
        "relative group transition-all duration-300 hover:-translate-y-1 hover:shadow-lg rounded-xl h-full flex flex-col w-full",
        selectedKpi === "rate" ? "z-30" : "z-10"
      )}>
        <div 
          onClick={() => setSelectedKpi(selectedKpi === "rate" ? null : "rate")}
          className="relative overflow-hidden rounded-xl border-none bg-gradient-to-br from-[#f87171] via-[#dc2626] to-[#b91c1c] dark:from-[#dc2626] dark:to-[#7f1d1d] p-5 active:scale-97 cursor-pointer glass-stat-card-red select-none h-full flex flex-col justify-between"
        >
      ...
      <div className={cn(
        ...
        <div 
          ...
          className="relative overflow-hidden rounded-xl border-none bg-gradient-to-br from-[#34d399] via-[#059669] to-[#047857] dark:from-[#059669] dark:to-[#024e37] p-5 active:scale-97 cursor-pointer glass-stat-card-green select-none h-full flex flex-col justify-between"
        >
          <div className="absolute inset-0 overflow-hidden rounded-xl pointer-events-none z-0">
