        ...
        <DialogHeader className="shrink-0 border-b border-gray-100 dark:border-white/10 bg-gray-50 dark:bg-white/5 px-6 py-4">
          <div className="flex items-center justify-between w-full gap-4">
            ...
            <div className="flex items-center gap-1.5 shrink-0">
              ...
              >
                <HugeIcon  className={cn("text-[16px]", isFullscreen ? "ph-bold ph-corners-in" : "ph-bold ph-corners-out")}></HugeIcon>
              </button>
              <button
                type="button"
                onClick={onClose}
        ...
        >
          ...
          {fileUrl ? (
            ...
            >
              ...
              <HugeIcon  className="ph-bold ph-arrow-square-out text-sm"></HugeIcon>
            </a>
          ) : null}
        </div>
      </DialogContent>
