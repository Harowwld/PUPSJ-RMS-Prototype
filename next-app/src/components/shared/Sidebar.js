      ...
      {items.map((item, idx) => {
        if (item.type === "header") {
          return (
            <div
              key={`header-${idx}`}
              className="mt-5 mb-2 px-2 text-[11px] font-semibold tracking-widest text-gray-500 first:mt-0 dark:text-zinc-400"
            >
              {item.label}
            </div>
          )
          ...
          return (
            <div key={item.key} className="flex flex-col gap-1">
              <button
                ...
                className={`flex w-full text-left items-center justify-between rounded-xl px-4 py-3.5 text-sm font-semibold whitespace-nowrap transition-colors outline-none focus-visible:ring-2 focus-visible:ring-pup-maroon/20 ${ hasActiveChild && !isExpanded ? "bg-red-50 text-pup-maroon dark:bg-red-500/10 dark:text-primary" : "text-gray-600 hover:bg-gray-100 hover:text-gray-900" } dark:focus-visible:ring-red-500/20 dark:text-zinc-400 dark:hover:bg-white/5 dark:hover:text-zinc-50`}
              >
                ...
                <div className="flex items-center gap-2">
                  {item.badge > 0 ? (
                    <span className={`inline-flex h-5 min-w-5 items-center justify-center rounded-full px-1.5 text-[11px] font-semibold text-white ${
                ...
                <div className="ml-6 flex flex-col gap-1 border-l-2 border-gray-100 pl-4 dark:border-white/5">
                  {item.children.map((child, childIdx) => (
                    <a
                      ...
                      className={`flex w-full text-left items-center justify-between gap-3 rounded-xl px-4 py-2.5 text-sm font-semibold whitespace-nowrap transition-all duration-300 outline-none focus-visible:ring-2 focus-visible:ring-pup-maroon/20 cursor-pointer ${ activeKey === child.key ? "bg-red-50 text-pup-maroon dark:bg-red-500/10 dark:text-primary" : "text-gray-600 hover:bg-gray-100 hover:text-gray-900" } dark:focus-visible:ring-red-500/20 dark:text-zinc-400 dark:hover:bg-white/5 dark:hover:text-zinc-50`}
                      style={{
 ...
 : "bg-emerald-600 dark:bg-emerald-950/60 dark:text-emerald-400 dark:ring-1 dark:ring-emerald-500/20"
        ...
        return (
          <a
            ...
            className={`flex w-full text-left items-center justify-between gap-3 rounded-xl px-4 py-3.5 text-sm font-semibold whitespace-nowrap transition-colors outline-none focus-visible:ring-2 focus-visible:ring-pup-maroon/20 cursor-pointer ${ activeKey === item.key ? "bg-red-50 text-pup-maroon dark:bg-red-500/10 dark:text-primary shadow-xs dark:shadow-none" : "text-gray-600 hover:bg-gray-100 hover:text-gray-900" } dark:focus-visible:ring-red-500/20 dark:text-zinc-400 dark:hover:bg-white/5 dark:hover:text-zinc-50`}
          >
            <span className="flex min-w-0 items-center gap-3">
              <i className={`${item.iconClass} text-lg`}></i> {item.label}
            </span>
