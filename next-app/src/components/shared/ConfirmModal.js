                          ...
                          <div 
                            ...
                            className={cn(
                              (isArchiveModal || isRestoreModal)
                                ...
                                : "text-[12px] font-normal text-gray-500 dark:text-zinc-400 font-mono truncate"
                            )}
                          >
                            {item}
                          </div>
