...
export default function StaffTabSkeleton() {
  return (
    <div className="flex flex-1 flex-col h-full min-h-0 w-full gap-4 animate-fade-up select-none font-inter">
      ...
      <div className="rounded-brand border border-gray-200 bg-white shadow-sm dark:border-white/10 dark:bg-card p-6 flex items-center justify-between">
      ...
      {/* Main Container Card */}
      <div className="overflow-hidden rounded-brand border border-gray-200 bg-white shadow-sm dark:border-white/10 dark:bg-card flex flex-col flex-1 min-h-[460px]">
        {/* Toolbar / Search Row */}
        <div className="flex items-center justify-between p-4 px-6 border-b border-gray-100 dark:border-white/5 bg-gray-50/40 dark:bg-white/[0.02]">
          <div className="flex items-center gap-3">
        ...
        <div className="flex items-center justify-between border-t border-gray-100 dark:border-white/10 p-4 px-6 bg-white dark:bg-card mt-auto">
