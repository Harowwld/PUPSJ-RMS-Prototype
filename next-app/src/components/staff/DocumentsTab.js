              ...
              <td className="p-4">
                {r.status === "uploaded" ? (
                  r.verificationStatus === "unverified" ? (
                    <span className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full border border-amber-500/20 bg-amber-500/10 text-[10px] font-black tracking-wider text-amber-600 dark:border-amber-400/20 dark:bg-amber-400/10 dark:text-amber-400">
                      <i className="ph-bold ph-warning-circle text-[11px]"></i>
                      Unverified
                    </span>
                  ) : (
                    <span className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full border border-emerald-500/20 bg-emerald-500/10 text-[10px] font-black tracking-wider text-emerald-600 dark:border-emerald-400/20 dark:bg-emerald-400/10 dark:text-emerald-400">
                      <i className="ph-bold ph-check-circle text-[11px]"></i>
                      Uploaded
                    </span>
                  )
                ) : (
                  <span className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full border border-red-500/20 bg-red-500/10 text-[10px] font-black tracking-wider text-red-600 dark:border-red-400/20 dark:bg-red-400/10 dark:text-red-400">
    ...
    >
      ...
      <div className="flex flex-col flex-1 h-auto">
        {docsLoading ? (
          ...
          <div className="overflow-hidden rounded-brand border border-gray-200 bg-white shadow-sm dark:border-white/10 dark:bg-card flex flex-col h-auto">
            {isSingleStudentView && (
            ...
            >
              <DocumentsTable
                ...
                setUpdateStudentNo={setUpdateStudentNo}
                setUpdateStudentName={setUpdateStudentName}
                setUpdateDocType={setUpdateDocType}
      ...
      >
        <DialogContent className="sm:max-w-md p-0 overflow-hidden bg-white border border-gray-200 shadow-2xl rounded-brand dark:bg-card dark:border-white/10">
          ...
          <div className="p-6 space-y-5">
            <div>
              <label className="block text-xs font-bold text-gray-700 mb-1.5 tracking-wide dark:text-zinc-200">
                Target Student
              </label>
              <Input
                disabled
