  ...
  return (
    <TooltipProvider delayDuration={200}>
      <div className="font-inter w-full flex flex-1 flex-col h-auto min-h-0 gap-6 focus:outline-none animate-fade-up">
                      ...
                      <td colSpan={8} className="border-0 p-0">
                        <Empty className="flex h-[400px] flex-col items-center justify-center border-0 bg-transparent text-center">
                          <EmptyHeader className="flex flex-col items-center gap-0">
                            ...
                            <EmptyTitle className="text-base font-semibold text-gray-900 dark:text-zinc-100">
                              {hasActiveFilters
                            ...
                            <EmptyDescription className="mt-1 max-w-sm text-xs font-normal text-gray-500 dark:text-zinc-400">
                              {hasActiveFilters
                                ...
                                : activeTab === "archive"
                                ? "Archived notifications will appear here for reference."
                                : "When administrators review uploaded documents, status decisions will be delivered here."}
                            </EmptyDescription>
                            {hasActiveFilters && (
                              <Button
                                variant="outline"
                                size="sm"
                                onClick={handleClearFilters}
                                className="mt-4 h-9 px-4 text-xs font-semibold rounded-xl border border-gray-200 dark:border-white/10 bg-white dark:bg-zinc-800 text-gray-700 dark:text-zinc-200 hover:bg-gray-50 dark:hover:bg-zinc-700 shadow-xs cursor-pointer active:scale-95 transition-all"
                              >
                                Clear Filters
                              </Button>
                            )}
                        ...
                        >
                          <td className="py-0 px-4 align-middle">
                            <div className="flex items-center gap-2">
                              <div
                                className={cn(
                                  "inline-flex w-fit items-center justify-center gap-1 rounded-full px-2.5 py-1 border text-[11px] font-medium tracking-[0.02em]",
                                  ui.badge
                                )}
                              >
                              ...
                              {isUnread ? (
                                <span className="animate-pulse inline-flex items-center rounded-full bg-pup-maroon/10 px-1.5 py-0.5 text-[9px] font-semibold tracking-wider text-pup-maroon dark:bg-red-400/10 dark:text-red-400">
                                  New
                                </span>
                              ) : null}
                            </div>
                              ...
                              {n.approval_status === "Declined" &&
                                ...
                                onRescan && (
                                  <Button
                                    ...
                                    className="h-7 px-3 text-xs font-semibold rounded-lg btn-brand-red text-white! shadow-xs active:scale-95 transition-all cursor-pointer whitespace-nowrap"
                                    style={{ color: "#ffffff" }}
                                  >
                                    Rescan
                                  </Button>
                    ...
                    <div className="flex items-center gap-1">
                      {[10, 20, 50, 100].map((size) => (
                        <button
                          ...
                          className={`px-2 py-0.5 rounded-lg text-[12px] font-normal cursor-pointer transition-colors border-0 ${
                            itemsPerPage === size
        ...
        {/* 6. Document Review Detail Dialog */}
        <Dialog
              ...
              <div className="flex items-center gap-3">
                <Tooltip>
                  <TooltipTrigger asChild>
                    ...
                    >
                      <i className={cn("ph-bold text-lg", isFullscreen ? "ph-corners-in" : "ph-corners-out")}></i>
                    </Button>
                  </TooltipTrigger>
                  <TooltipContent className="bg-zinc-900 text-white border-zinc-800">
              ...
              <div className="flex items-center gap-3">
                ...
                {selectedNotif?.approval_status === "Declined" && activeTab !== "archive" && onRescan ? (
                  <Button
                    ...
                    className="h-10 px-6 text-xs font-semibold rounded-xl btn-brand-red text-white! shadow-xs active:scale-95 transition-all cursor-pointer"
                    style={{ color: "#ffffff" }}
                  >
                    Rescan
                  </Button>
