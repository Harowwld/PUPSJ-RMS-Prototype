    ...
    <header className="bg-[#f2f2f7] dark:bg-card border-b border-gray-300 flex-none z-20 select-none transition-colors duration-300 dark:border-white/5">
      ...
      <div className="w-full px-4 h-16 flex items-center justify-between">
        <div className="flex items-center gap-[6px]">
          ...
          >
            <img src={(pathname?.startsWith("/account") ? hasAdminRights : isAdminView) ? "/admin-logo.png" : "/staff-logo.png"} alt="eManage Logo" className="h-8 w-8 shrink-0 object-contain p-0.5" />
