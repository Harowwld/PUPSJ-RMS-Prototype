      ...
      <div className="h-screen flex items-center justify-center relative overflow-hidden">
        ...
        <div className={`w-full ${view === "login" ? "max-w-[480px]" : "max-w-lg"} transition-all duration-300 p-4 animate-fade-up z-10`}>
          <div className="text-center mb-10">
            <div className="inline-flex items-center justify-center w-24 h-24 bg-white rounded-3xl shadow-md mb-4 border border-pup-border">
              <i className="ph-bold ph-bank text-5xl text-pup-maroon"></i>
            </div>
            <h1 className="text-3xl font-black text-pup-maroon tracking-tighter uppercase leading-none">
              PUP E-Manage
            </h1>
            <p className="text-sm font-bold text-gray-500 uppercase tracking-[0.2em] mt-2">
              Student Record Keeping System
            </p>
          </div>

          <div className="bg-white rounded-[2.5rem] border border-gray-100 shadow-2xl shadow-gray-200/50 p-12">
            {view === "login" ? (
              <>
                <div className="mb-6 border-t border-gray-50 pt-6 flex flex-col gap-0.5">
                  <h2 className="text-lg font-black text-gray-900 tracking-tight text-left leading-tight">Account Login</h2>
                  <p className="text-xs font-medium text-gray-500 text-left leading-tight">
                ...
                <form onSubmit={handleLogin} className="space-y-4">
                  <div>
                    <div className="relative group">
                      <label className="absolute left-4 top-1.5 text-[8px] font-black uppercase tracking-[0.15em] text-gray-400 pointer-events-none transition-all duration-300 group-focus-within:text-pup-maroon">
                        Email Address
                      </label>
                      <Input
                        type="text"
                        id="username"
                        className="pt-6 pb-2 px-4 bg-gray-50/40 border-gray-100 rounded-xl text-sm font-bold text-gray-900 focus-visible:bg-white focus-visible:ring-4 focus-visible:ring-pup-maroon/5 focus-visible:border-pup-maroon/20 focus-visible:outline-none transition-all duration-300 h-12"
                  ...
                  <div>
                    <div className="relative group">
                      <label className="absolute left-4 top-1.5 text-[8px] font-black uppercase tracking-[0.15em] text-gray-400 pointer-events-none transition-all duration-300 group-focus-within:text-pup-maroon">
                        ...
                        id="password"
                        className="pt-6 pb-2 pl-4 pr-12 bg-gray-50/40 border-gray-100 rounded-xl text-sm font-bold text-gray-900 focus-visible:bg-white focus-visible:ring-4 focus-visible:ring-pup-maroon/5 focus-visible:border-pup-maroon/20 focus-visible:outline-none transition-all duration-300 h-12"
                        placeholder="••••••••"
                        required
                        value={password}
                      ...
                      <button
                        ...
                        className="absolute right-4 top-[60%] -translate-y-1/2 text-gray-400 hover:text-pup-maroon transition-colors z-10"
                      >
                  ...
                  {error ? (
                    <div className="p-3 bg-red-50 border border-red-100 rounded-xl animate-in shake-1">
                  ...
                  <Button
                    type="submit"
                    disabled={isLoading}
                    className="w-full h-11 bg-linear-to-b from-red-800 to-pup-maroon border-4 border-pup-darkMaroon hover:from-red-700 hover:to-red-900 hover:shadow-md text-white font-bold text-sm shadow-sm active:scale-95 transition-all disabled:opacity-50 disabled:pointer-events-none group"
                  >
                    {isLoading ? (
                  ...
                  <div className="text-center pt-3 border-t border-gray-50">
                    <button
                      ...
                      className="text-[9px] font-black tracking-widest text-gray-400 hover:text-pup-maroon transition-colors uppercase"
                    >
                      Account Recovery
                    </button>
                  </div>
              ...
              <>
                <div className="mb-6 border-t border-gray-50 pt-6 flex flex-col gap-0.5">
                  <h2 className="text-lg font-black text-gray-900 tracking-tight text-left leading-tight">Account Recovery</h2>
                  <p className="text-xs font-medium text-gray-500 text-left leading-tight">
                    {forgotStep === 1
                ...
                {forgotStep === 1 ? (
                  <form onSubmit={handleForgotIdentify} className="space-y-4">
                    {forgotError && (
                      <div className="p-3 bg-red-50 border border-red-100 rounded-xl animate-in shake-1">
                        <p className="text-[11px] font-bold text-red-800">{forgotError}</p>
                      </div>
                    )}
                    <div className="relative group">
                      <label className="absolute left-4 top-1.5 text-[8px] font-black uppercase tracking-[0.15em] text-gray-400 pointer-events-none transition-all duration-300 group-focus-within:text-pup-maroon">
                    ...
                    <div className="flex flex-col gap-3">
                      <Button
                        ...
                        className="w-full h-11 bg-linear-to-b from-red-800 to-pup-maroon border-4 border-pup-darkMaroon hover:from-red-700 hover:to-red-900 hover:shadow-md text-white font-bold text-sm shadow-sm active:scale-95 transition-all disabled:opacity-50 group"
                      >
                        {forgotLoading ? (
                           <div className="flex items-center gap-2">
                             <i className="ph-bold ph-spinner animate-spin text-lg"></i>
                  ...
                  <form onSubmit={handleForgotReset} className="space-y-4">
                    ...
                    <div className="relative group">
                      ...
                      <Select
                        className="pt-6 pb-2 px-3 bg-gray-50/40 border-gray-100 rounded-xl text-sm font-bold text-gray-900 focus:ring-4 focus:ring-pup-maroon/5 focus:border-pup-maroon/20 outline-none transition-all duration-300 h-12 w-full appearance-none"
